// Version optimisée de app.cjs pour démarrage rapide
...
// Health check endpoint - chargé immédiatement
...
// API documentation endpoint - chargé immédiatement
app.get('/api', (req, res) => {
  res.json({
    success: true,
...
// Middleware de chargement des routes en arrière-plan
...
// Démarrer le chargement des routes en arrière-plan
setImmediate(loadRoutesInBackground);
